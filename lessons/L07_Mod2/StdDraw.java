 ...
 *  By default, all drawing takes place in the unit square, with (0, 0) at
 ...
 *  <p>
 *  We recommend using PNG for drawings that consist solely of geometric shapes
 *  and JPEG for drawings that contain pictures.
 ...
 *  The last two methods tell you the <em>x</em>- and <em>y</em>-coordinates of the mouse's
 ...
 *  background color, pen radius, and font:
 *  <ul>
 *  <li> {@link #getPenColor()}
 ...
 *       Java will cache the image file, so you do not incur the cost of reading
 *       from a file each time.
 *  <li> By default, {@code StdDraw} optimizes rendering for display quality.
 *       To optimize for speed, call {@link #setRenderingSpeed()}.
 *  </ul>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static RenderingHints renderingHints = createRenderingHintsQuality();
    ...
    /**
     * Sets the canvas (drawing area) to the default of 512-by-512 pixels.
    ...
    private static void initCanvas() {
        // dispose of old Graphics2D objects
        ...
        // add antialiasing and other rendering hints
        applyRenderingHints();
    }


    /**
     * Returns rendering hints that favor high-quality drawing.
     */
    private static RenderingHints createRenderingHintsQuality() {
    ...
    /**
     * Returns rendering hints that favor faster drawing.
     */
    private static RenderingHints createRenderingHintsSpeed() {
        RenderingHints hints = new RenderingHints(null);
        hints.put(RenderingHints.KEY_ANTIALIASING,      RenderingHints.VALUE_ANTIALIAS_OFF);
        hints.put(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_OFF);
        hints.put(RenderingHints.KEY_RENDERING,         RenderingHints.VALUE_RENDER_SPEED);
        hints.put(RenderingHints.KEY_INTERPOLATION,     RenderingHints.VALUE_INTERPOLATION_BILINEAR);
        // BILINEAR is a reasonable speed/quality compromise.
        // Use VALUE_INTERPOLATION_NEAREST_NEIGHBOR for maximum speed.

        return hints;
    }

    /**
     * Applies the current rendering hints to the specified graphics context.
     */
    private static void applyRenderingHints(Graphics2D graphics) {
        if (graphics != null) {
            graphics.addRenderingHints((RenderingHints) renderingHints.clone());
        }
    }

    /**
     * Applies the current rendering hints to all active drawing buffers.
     */
    private static void applyRenderingHints() {
        applyRenderingHints(offscreen);
        applyRenderingHints(onscreen);
    }
    ...
    ***************************************************************************/
    ...
    /**
     * Sets the rendering hints to favor high-quality drawing.
     * This is the default setting.
     * <p>
     * This setting affects subsequent drawing commands; it does not
     * re-render shapes, text, or pictures that have already been drawn.
     */
    public static void setRenderingQuality() {
        renderingHints = createRenderingHintsQuality();
        applyRenderingHints();
    }

    /**
     * Sets the rendering hints to favor faster drawing.
     * <p>
     * This may reduce the quality of antialiasing, text rendering, and
     * scaled images. This setting affects subsequent drawing commands;
     * it does not re-render shapes, text, or pictures that have already
     * been drawn.
     */
    public static void setRenderingSpeed() {
        renderingHints = createRenderingHintsSpeed();
        applyRenderingHints();
    }

    /**
     * Restores the default rendering hints.
     * <p>
     * This is equivalent to calling {@link #setRenderingQuality()}.
     */
    ...
    /**
     * Replaces the current rendering hints with the specified rendering hints.
     * <p>
     * The {@code StdDraw} class makes a defensive copy of the argument because
     * {@link RenderingHints} is mutable. Changing the argument after calling this
     * method will not affect the rendering hints used by {@code StdDraw}.
     * <p>
     * This setting affects subsequent drawing commands; it does not re-render
     * shapes, text, or pictures that have already been drawn.
     *
     * @param hints the rendering hints
     * @throws IllegalArgumentException if {@code hints} is {@code null}
     */
    public static void setRenderingHints(RenderingHints hints) {
        validateNotNull(hints, "rendering hints");
        renderingHints = (RenderingHints) hints.clone();
        applyRenderingHints();
    }

    /**
     * Adds the specified rendering hints to the current rendering hints.
     * <p>
     * If a key in the specified rendering hints is already present in the current
     * rendering hints, its value is replaced. The {@code StdDraw} class makes a
     * defensive copy of the argument because {@link RenderingHints} is mutable.
     * Changing the argument after calling this method will not affect the
     * rendering hints used by {@code StdDraw}.
     * <p>
     * This setting affects subsequent drawing commands; it does not re-render
     * shapes, text, or pictures that have already been drawn.
     *
    ...
    public static void addRenderingHints(RenderingHints hints) {
        validateNotNull(hints, "rendering hints");
        renderingHints.add((RenderingHints) hints.clone());
        applyRenderingHints();
    }

    /**
     * Returns a copy of the current rendering hints.
     * <p>
     * The returned object is a defensive copy. Changing it will not affect
     * the rendering hints used by {@code StdDraw}.
     *
     * @return a copy of the current rendering hints
     */
...
*/
     ...
     * As an optimization, Java caches the picture at the file system level,
     * which significantly improves performance for redrawing the same image
     * multiple times (e.g., in an animation). However, if you change the
    ...
    ***************************************************************************/
     ...
     * If double buffering is enabled, it saves the onscreen buffer (i.e, what
     * is displayed on the screen), not the offscreen buffer.
     *
    ...
    ***************************************************************************/
    ...
    private static class RetinaImageIcon extends ImageIcon {
        ...
        public synchronized void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            try {
                StdDraw.applyRenderingHints(g2);
                g2.scale(0.5, 0.5);
                super.paintIcon(c, g2, 2*x, 2*y);
            }
            finally {
                g2.dispose();
            }
